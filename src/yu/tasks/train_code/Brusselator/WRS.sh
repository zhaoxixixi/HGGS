# brusselator WRS
python multi_seed_train.py [0,1] [2,3] "WRS-1w" \
--data_path /brusselator/train/Baseline/WRS --model_path "/brusselator/" \
--seeds "[53]" --iter_count 20 --Algorithm_type "[\"../../../../data/2param/brusselator/train/Baseline/WRS/pool-5k.csv\", 250]" \
...
--train_strategy WRS --ode_model_name brusselator --lr_alpha 0.2 \
