# brusselator VeSSAL
python multi_seed_train.py [0,1] [2,3] "VeSSAL-5k" \
--data_path /brusselator/train/Baseline/VeSSAL --model_path "/brusselator/" \
...
--train_strategy VeSSAL --ode_model_name brusselator --lr_alpha 0.2 \
