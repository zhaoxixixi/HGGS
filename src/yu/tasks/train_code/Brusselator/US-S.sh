# brusselator US-S
python multi_seed_train.py [0,1] [2,3] "US-S-5k" \
--data_path /brusselator/train/Baseline/US-S --model_path "/brusselator/" \
...
--train_strategy US-S --ode_model_name brusselator --lr_alpha 0.2 \
