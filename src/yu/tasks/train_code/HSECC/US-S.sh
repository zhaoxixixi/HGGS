# HSECC US-S
python multi_seed_train.py [0,1,2,3,4,5] [6,7,8] "US-S-5k" \
--data_path /HSECC/train/Baseline/US-S/ --model_path "/HSECC/" \
...
--train_strategy US-S --ode_model_name HSECC --lr_alpha 0.2 \
