# HSECC US-P
python multi_seed_train.py [0,1,2,3,4,5] [6,7,8] "US-P-5k" \
--data_path /HSECC/train/Baseline/US-P/ --model_path "/HSECC/" \
--seeds "[53]" --iter_count 20 --Algorithm_type "[\"../../../../data/6param/HSECC/train/Baseline/US-P/pool-1w.csv\", 250]" \
...
--train_strategy US-P --ode_model_name HSECC --lr_alpha 0.2 \
