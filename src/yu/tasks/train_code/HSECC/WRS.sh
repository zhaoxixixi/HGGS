# HSECC WRS-5k
python multi_seed_train.py [0,1,2,3,4,5] [6,7,8] "WRS-1w" \
--data_path /HSECC/train/Baseline/WRS --model_path "/HSECC/" \
--seeds "[53]" --iter_count 20 --Algorithm_type "[\"../../../../data/6param/HSECC/train/Baseline/WRS/pool-5k.csv\", 250]" \
...
--train_strategy WRS --ode_model_name HSECC --lr_alpha 0.2 \
