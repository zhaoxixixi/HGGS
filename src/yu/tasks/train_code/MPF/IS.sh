# MPF IS
python multi_seed_train.py [0,1,2,3,4,5] [6,7] "IS" \
--data_path /MPF_2_Var/train/Baseline/IS --model_path "/MPF_2_Var/" \
...
--train_strategy IS --ode_model_name MPF_2_Var --lr_alpha 0.2 \
...
--total_training_samples 10000 --dropout 0.1 --batch_size 409600 \
