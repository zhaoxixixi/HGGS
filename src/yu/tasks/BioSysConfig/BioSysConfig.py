...
class SysConfig():
    def __init__(self, sampling_name: str, sys_name: str):
        ...
        if sys_name == 'brusselator':
            self.xs = [0,1]
            self.ys = [2,3]
            self.data_path = "/brusselator/train/GG-Sampling/"
            ...
            self.xs = [0, 1, 2, 3, 4, 5]
            self.ys = [6, 7, 8]
            self.data_path = "/HSECC/train/GG-Sampling/"
            ...
            self.xs = [0, 1, 2, 3, 4, 5]
            self.ys = [6, 7]
            self.data_path = "/MPF_2_Var/train/GG-Sampling/"
            ...
            self.xs = [0, 1, 2, 3, 4, 5]
            self.ys = [6, 7]
            self.data_path = "/PS2_01/train/GG-Sampling/"
